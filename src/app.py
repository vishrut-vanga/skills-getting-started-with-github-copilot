...
activities = {
    ...
    "Basketball Team": {
        "description": "Develop basketball skills and play in local tournaments",
    ...
    "Science Olympiad": {
        "description": "Solve challenging science problems and compete in events",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["ben@mergington.edu", "charlotte@mergington.edu"]
    }
}
